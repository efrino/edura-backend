...
//             // ✏️ PUT /admin/class/{id} - Update any class
//             {
//                 method: 'PUT',
//                 path: '/admin/class/{id}',
//                 options: {
//                     tags: ['api', 'Admin'],
//                     description: 'Admin - Update kelas manapun',
//                     pre: [verifyToken, requireRole('admin')],
//                     validate: {
//                         params: Joi.object({
...
//                         // If teacher_id is being changed, verify new teacher
//                         if (updateData.teacher_id && updateData.teacher_id !== existingClass.teacher_id) {
//                             const { data: teacher, error: teacherError } = await db
//                                 .from('users')
//                                 .select('id, full_name')
...
//                             if (teacherError || !teacher) {
//                                 return Boom.badRequest('Teacher baru tidak ditemukan atau role tidak valid');
//                             }
//                         }

//                         // If name is being changed, check for duplicates
//                         if (updateData.name && updateData.name.trim() !== existingClass.name) {
//                             const teacherId = updateData.teacher_id || existingClass.teacher_id;
